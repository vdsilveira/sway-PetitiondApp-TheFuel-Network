...
(() => {
  ...
  function errorFunc(reason, offset, bytes2, output2, badCodepoint) {
    return logger2.throwArgumentError(`invalid codepoint at offset ${offset}; ${reason}`, "bytes", bytes2);
  }
  ...
  function computeHmac(algorithm, key, data) {
    if (!SupportedAlgorithm[algorithm]) {
      logger3.throwError("unsupported algorithm " + algorithm, Logger.errors.UNSUPPORTED_OPERATION, {
        operation: "hmac",
        algorithm
      });
    }
