...
function toBech32(address) {
  return import_bech32.bech32m.encode(
    ...
    import_bech32.bech32m.toWords((0, import_bytes.arrayify)((0, import_bytes.hexlify)(address)))
  );
}
...
function toB256(address) {
  ...
  return (0, import_bytes.hexlify)(getBytesFromBech32(address));
}
...
var getRandomB256 = () => (0, import_bytes.hexlify)((0, import_crypto.randomBytes)(32));
var clearFirst12BytesFromB256 = (b256) => {
  ...
  try {
    ...
    bytes = (0, import_bytes.hexlify)(bytes.fill(0, 0, 12));
  } catch (error) {
    throw new import_errors.FuelError(
...
var Address = class extends import_interfaces2.AbstractAddress {
  ...
  static fromPublicKey(publicKey) {
    const b256Address = (0, import_sha2.sha256)(publicKey);
