...
import { arrayify as arrayify2, concat as concat2 } from "@ethersproject/bytes";
...
var SCRIPT_DATA_BASE_OFFSET = VM_TX_MEMORY + SCRIPT_FIXED_SIZE;
...
var BaseInvocationScope = class {
  ...
  getRequiredCoins() {
    ...
    })).concat(this.transactionRequest.calculateFee(gasPriceFactor)).filter(({ assetId, amount }) => assetId && !bn3(amount).isZero());
    return assets;
  }
  /**
