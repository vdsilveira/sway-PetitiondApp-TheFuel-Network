...
`);
  ...
  function getSupportedVersions2() {
    return {
      FORC: "0.44.0",
      FUEL_CORE: "0.20.5",
      FUELS: "0.60.0"
  ...
  var versions2 = getSupportedVersions2();
...
`;
  ...
  __publicField4(StructType, "IGNORE_REGEX", /^struct (Vec|RawVec|EvmAddress)$/m);
...
`;
  ...
  function configureCliOptions(program2) {
    program2.requiredOption("-i, --inputs <path|glob...>", "input paths/globals to your abi json files").requiredOption("-o, --output <dir>", "directory path for generated files").addOption(
  ...
  var colorizeUserVersion = (params) => {
    ...
    if (isGt) {
      return (0, import_chalk2.cyan)(version3);
    }
    if (isOk) {
      return (0, import_chalk2.green)(version3);
    }
    return (0, import_chalk2.red)(version3);
  };
  function getSupportedVersions3() {
    return {
      FORC: "0.44.0",
      FUEL_CORE: "0.20.5",
      FUELS: "0.60.0"
  ...
  function compareUserVersions(params) {
    ...
    const versions3 = getSupportedVersions3();
    const userForcIsGt = import_semver.default.gt(userForcVersion, versions3.FORC);
    const userFuelCoreIsGt = import_semver.default.gt(userFuelCoreVersion, versions3.FUEL_CORE);
    const userForcIsEq = import_semver.default.eq(userForcVersion, versions3.FORC);
    const userFuelCoreIsEq = import_semver.default.eq(userFuelCoreVersion, versions3.FUEL_CORE);
    return {
      userForcIsGt,
      userFuelCoreIsGt,
      userForcIsEq,
  ...
  function runVersions() {
    ...
    const supportedVersions = getSupportedVersions3();
    const cliTable = new import_cli_table.default({
      head: ["", (0, import_chalk.bold)("Supported"), (0, import_chalk.bold)(`Yours / System`)]
    });
    const fuelUpLink = (0, import_chalk.green)("https://github.com/fuellabs/fuelup");
  ...
  function run(argv) {
    ...
    const typegen = program2.command("typegen").description(`generate typescript from contract abi json files`);
    configureCliOptions(typegen);
    program2.parse(argv);
  }
